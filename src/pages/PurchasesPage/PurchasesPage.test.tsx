...
describe('Purchases page tests', (): void => {
  ...
  test('renders the main HTML div element of PurchasesPage component with OrderForm component', async () => {
    await act(async () => {
      renderPurchasesPage();
    });
  ...
  test('should display correct number of cat options and cat selector', async () => {
    await act(async () => {
      renderPurchasesPage();
    });
